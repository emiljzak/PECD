...
def plot_elfield(Fvec,tgrid,time_to_au):
    ...
    ax.scatter(tgrid/time_to_au, -Fvec[0].real-Fvec[2].real, label = "Field-x", marker = '.', color = 'r', s = 1)
    ax.scatter(tgrid/time_to_au, Fvec[0].imag+Fvec[2].imag, label = "Field-y", marker = '.', color = 'g', s = 1)

...
def read_input():
    ...
    params['job_label']    = "test_orient_density_new_beta" 
    ...
    params['N_euler'] 	        = 12    # number of euler grid points per dimension (beta angle) for orientation averaging. Alpha and gamma are on double-sized grid.
